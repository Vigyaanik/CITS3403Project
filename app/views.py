...
@app.route('/getGame/<int:numColls>/<int:numRows>/<int:time>/<string:folderName>/<string:assessment>')
def getGame(numColls,numRows,folderName,time, assessment):
    if 'username' in session:
        ...
        if assessment == 'False':
            return render_template('game.html', numColls=numColls, numRows=numRows,paths=for_use,folderName=folderName, time=time)
        elif assessment == 'True': 
            return render_template('assessment_game.html',numColls=numColls, numRows=numRows,paths=for_use,folderName=folderName, time=time)
        else:
...
def statisticspage():
    if 'username' in session:
        ...
        plt.hist(Allresults)
        plt.title("number of flips in all assesed submissions")
        plt.xlabel("number of flips")
        plt.ylabel("frequency")
        plt.savefig("app/static/AllPlot.png") 
        #plt.histogram(UseResults)
